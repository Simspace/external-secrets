...
// GetItemByTitle fake
func (mockClient *OnePasswordMockClient) GetItemByTitle(title string, vaultUUID string) (*onepassword.Item, error) {
	return &onepassword.Item{}, nil
}
...
// GetFile fake
func (mockClient *OnePasswordMockClient) GetFile(fileUUID string, itemUUID string, vaultUUID string) (*onepassword.File, error) {
